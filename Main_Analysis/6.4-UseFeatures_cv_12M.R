...
# mkdir
dir.save <- "RESULT/6.4-UseFeatures_cv_12M"
dir.log <- "RESULT/6.4-UseFeatures_cv_12M/Logfile"
...
if ( name.feature == "Prox_100kb" ) {
   GenReMat_prox <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_PROX.100Kb_Prox_For", pop2, ".csv"), row.names = 1))
   GenReMat_non <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_PROX.100Kb_Dist_For", pop2, ".csv"), row.names = 1))
   ETA <- list("G1" = list(K = GenReMat_prox, model = "RKHS"),
               "G2" = list(K = GenReMat_non, model = "RKHS"))
}
if ( name.feature == "Prox_10kb" ) {
   GenReMat_prox <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_PROX.10Kb_Prox_For", pop2, ".csv"), row.names = 1))
   GenReMat_non <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_PROX.10Kb_Dist_For", pop2, ".csv"), row.names = 1))
   ETA <- list("G1" = list(K = GenReMat_prox, model = "RKHS"),
               "G2" = list(K = GenReMat_non, model = "RKHS")) # model
}
if ( name.feature == "Prox_1kb" ) {
   GenReMat_prox <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_PROX.1Kb_Prox_For", pop2, ".csv"), row.names = 1))
   GenReMat_non <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_PROX.1Kb_Dist_For", pop2, ".csv"), row.names = 1))
   ETA <- list("G1" = list(K = GenReMat_prox, model = "RKHS"),
               "G2" = list(K = GenReMat_non, model = "RKHS")) # model
}
if ( name.feature == "GERP" ) {
   GenReMat_GERP_posi <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_GERP_Positive_For", pop2, ".csv"), row.names = 1))
   GenReMat_GERP_nega <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_GERP_Negative_For", pop2, ".csv"), row.names = 1))
   ETA <- list("G1" = list(K = GenReMat_GERP_posi, model = "RKHS"),
               "G2" = list(K = GenReMat_GERP_nega, model = "RKHS")) # model
}
if ( name.feature == "RecRate" ) {
   GenReMat_RecRate_high <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_REC.RATE_High_For", pop2, ".csv"), row.names = 1))
   GenReMat_RecRate_middle <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_REC.RATE_Middle_For", pop2, ".csv"), row.names = 1))
   GenReMat_RecRate_low <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_REC.RATE_Low_For", pop2, ".csv"), row.names = 1))
...
if ( name.feature == "MAF" ) {
   GenReMat_MAF_high <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_MAF_High_For", pop2, ".csv"), row.names = 1))
   GenReMat_MAF_middle <- as.matrix(read.csv(paste0("RESULT/1.7-UseFeatures/Use_12M/GenReMat_use_12M_SNP_MAF_Middle_For", pop2, ".csv"), row.names = 1))
